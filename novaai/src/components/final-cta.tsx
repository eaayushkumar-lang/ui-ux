...
import { sectionRaised, sectionDivider } from "@/lib/section-style";
import { cn } from "@/lib/utils";

export function FinalCta() {
  return (
    <section className={cn("px-5 py-20 sm:px-8 sm:py-28 md:px-12 md:py-32", sectionRaised, sectionDivider)}>
      <div className="glass-panel mx-auto max-w-4xl rounded-3xl px-6 py-16 text-center sm:px-12 sm:py-20">
        <Reveal
          as="h2"
